<!DOCTYPE HTML>
	...
	$Obj_Query = $pdo->query("SELECT objet.Nom as NO, ID_U, Date_deb, Date_fin, Description, Prix_actuel, Prix_base, Photo, Adresse, Utilisateur.Nom as NU, Numero, Email FROM objet INNER JOIN Utilisateur WHERE Pseudo = Objet.ID_U AND idObjet ='".$_GET["Obj_Id"]."'");
					...
					<div class="row double">
                        ...
                        <section class="4u">
                           <header>
                            ...
                            <p>
								<?php
								echo "<td>".$Obj_pres['Description']."</td> </br>";
